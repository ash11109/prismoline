          ...
          <div className='row'>
            <div className='col-xl-3 col-md-6'>
              <div className='single-work-process-inner'>
                ...
                {/* <div className='thumb mx-auto mb-3'>
                  <img className="mx-auto px-auto"  width={70} src='assets/img/icon/gb.svg' alt='img' />
                </div> */}
                <div className='details'>
                  {/* <p className='process-count'>Work 01</p> */}
                  <h5 className='mb-3'>Government</h5>
                  <p className='content'>
            ...
            <div className='col-xl-3 col-md-6'>
              <div className='single-work-process-inner'>
                ...
                <div className='details'>
                  ...
                  <h5 className='mb-3'>Engineers & Architects</h5>
                  <p className='content'>
            ...
            <div className='col-xl-3 col-md-6'>
              <div className='single-work-process-inner'>
                ...
                <div className='details'>
                  ...
                  <h5 className='mb-3'>Military & Airport</h5>
                  <p className='content'>
            ...
            <div className='col-xl-3 col-md-6'>
              <div className='single-work-process-inner'>
                ...
                <div className='details'>
                  {/* <p className='process-count'>Work 04</p> */}
                  <h5 className='mb-3'>Commercial</h5>
                  <p className='content'>
            ...
            <div className='col-xl-3 col-md-6'>
              <div className='single-work-process-inner'>
                ...
                <div className='details'>
                  ...
                  <h5 className='mb-3'>Contractors</h5>
                  <p className='content'>
            ...
            <div className='col-xl-3 col-md-6'>
              <div className='single-work-process-inner'>
                ...
                <div className='details'>
                  {/* <p className='process-count'>Work 04</p> */}
                  <h5 className='mb-3'>Global Exports</h5>
                  <p className='content'>
